...
$string['bookingmovedmessage']        = 'Your {$a->name} booking has been moved from Room {$a->oldroom} to Room {$a->newroom} in {$a->area} for the lesson on {$a->date}, {$a->starttime}. The room is required for {$a->newbookingname}.\n\nWARNING: this move has been done by a computer making a calculated best guess, please check that the room is suitable before the lesson';
...
$string['mail_subject_entry'] = 'Entry added/changed for {$a->date} (by {$a->user})';
$string['mail_subject_delete'] = 'Entry deleted for {$a->date} (booked by {$a->user}) ';
